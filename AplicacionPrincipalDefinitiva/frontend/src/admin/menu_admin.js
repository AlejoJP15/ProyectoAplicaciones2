      ...
      <nav className="bg-blue-600 text-white shadow-lg">
        <div className="container mx-auto flex justify-between items-center p-4">
          ...
          <ul className="flex space-x-6">
            <li className="hover:underline cursor-pointer" onClick={() => navigate("/admin/gestion_usuario_admin")}>
              Gestionar Usuarios
            </li>
            <li className="hover:underline cursor-pointer" onClick={() => navigate("/admin/visualizar_estadisticas_admin")}>
